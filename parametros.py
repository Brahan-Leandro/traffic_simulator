...
N_densidad = 0.05		#probabilidad de la cantidad de carros que salen desde el norte
S_densidad = 0.05		#probabilidad de la cantidad de carros que salen desde el sur
W_densidad = 0.05  		#probabilidad de la cantidad de carros que salen desde el oeste
E_densidad = 0.05		#probabilidad de la cantidad de carros que salen desde el Este

N_E_probabilidad = 0.5
N_W_probabilidad = 0.5
